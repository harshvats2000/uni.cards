...
const Section3 = () => {
  return (
    <section className="py-12 lg:py-[100px] bg-black py-8 relative">
      <img src={`${BASE_URL}/images/circles.png`} alt="circles" className="absolute top-0 h-auto w-[70%]" />
      <div className="w-full max-w-7xl mx-auto px-6 md:px-4  md:flex relative py-6">
        ...
        <div className="m-auto w-full md:w-[450px] h-auto md:flex-[50%]">
          <img
            src={`${BASE_URL}/images/nx-wave/app_screen_1.webp`}
            alt=""
            loading="lazy"
      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-4  md:flex relative py-6">
        <div className="mx-auto w-full flex-[50%] flex-grow-0 my-auto">
          ...
          <p className="text-[#BFC9CC] text-[14px] md:text-2xl">
            Set your own payment limits. Choose how and where you spend. Lock and unlock your card. All right from the
            app.{" "}
          </p>
        </div>
        <div className="m-auto w-full md:w-[450px] h-auto md:flex-[50%]">
          <img
            src={`${BASE_URL}/images/nx-wave/app_screen_2.webp`}
            alt=""
            loading="lazy"
            className="m-auto w-[80%] h-auto css-1e2fy0l"
          />
